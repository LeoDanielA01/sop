...
import { Badge, PageHeader, PageHeaderTitle, createResource } from 'frappe-ui'
...
<template>
  ...
  <div class="mx-auto mt-5 w-full max-w-[940px] px-3 pb-10 sm:px-5">
      ...
      <ListRow v-for="row in rows" :key="row.name" class="h-15">
        ...
        <ListCell>
          <div class="min-w-0 flex-1">
            ...
            <!-- The cause is the audit answer: a direct edit, a block, or a change set. -->
    ...
    <p v-if="!revisions.loading && !rows.length" class="mt-16 text-center text-base text-ink-gray-5">
